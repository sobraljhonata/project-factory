...
**Estado:** **Beta Internal Stable** — beta interna com a **fase backend/API** do stack `api-node-express` **encerrada** (contrato [Web Core V3.5.3](docs/web-core-contract.md), template **1.0.8**). Limites e garantias da beta: [docs/BETA_SCOPE.md](docs/BETA_SCOPE.md). **Adopção e operação:** [docs/adoption-playbook.md](docs/adoption-playbook.md), [docs/versioning-policy.md](docs/versioning-policy.md), [docs/roadmap.md](docs/roadmap.md) (inclui **próximo capítulo: frontend factory**). Mudanças notáveis: [CHANGELOG.md](CHANGELOG.md).

**Índice da documentação:** [docs/README.md](docs/README.md) (mapa de todos os docs por intenção). **Contrato HTTP do stack gerado (V3.5.3):** [docs/web-core-contract.md](docs/web-core-contract.md).
...
| `templates/application-modules/*` | Módulos opcionais (`swagger-rich`, `auth-jwt`, `observability-basic`, `rate-limit-basic`, …): `module.json` + ficheiros sob `src/`. |
